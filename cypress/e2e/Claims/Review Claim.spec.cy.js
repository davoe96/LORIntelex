...
describe ('As a user I want to successfully Review Claims and validate the user journey', function(){
...
describe ('Review Claim', () =>{
      beforeEach(() => {
       ...
       //it('Successfully access the form to create a new injury claim', function() {
        ...
        it('Successfully access the Review Claim Table and validate the Open Claim requirements', function() {
            ...
            cy.contains('Cancel Claim').should('be.visible')
            ...
            cy.get('a[href="/Login/LOR_AUSTest/IntelexForms/WorkflowService/ExecuteAction/8d6654bb-3c6f-4ade-9af2-7ab0d113300a?recordId=f8fa40bd-12af-41a4-bf64-839164c6128e&objectName=ClaimsMgmt_InjuryClaimObject"]').click({force: true});
            cy.get('a[href="/Login/LOR_AUSTest/IntelexForms/WorkflowService/ExecuteAction/8d6654bb-3c6f-4ade-9af2-7ab0d113300a?recordId=f8fa40bd-12af-41a4-bf64-839164c6128e&objectName=ClaimsMgmt_InjuryClaimObject"]').click({force: true});
        })
